...
`python predict.py -c './config.json' -i  './cimg/'  -o './bbox_imgs/'`


   `-i   'path to an image, a directory of images'`
...
The number plate prediction are printed to the output for all images in folder
